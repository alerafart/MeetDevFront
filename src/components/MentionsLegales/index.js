...
function MentionsLegales() {
  return (
    <div className="mentionslegales">
      ...
      Meet Dev Numéro de SIRET : 012345678910

      Téléphone : 01 02 03 04 05

      Email : contact@meetdev.fr

      Site Web : www.meetdev.fr
      ...
      (HTML, Javascript, CSS, React) pour un meilleur confort d’utilisation
      ...
      par écrit de Meet Dev. Cette représentation ou reproduction,
      par quelque procédé que ce soit, constitue une contrefaçon sanctionnée par
