...
function MentionsLegales() {
  return (
    <div className="mentionslegales">
      ...
      <p>En vous connectant sur ce site, vous acceptez, sans réserves, les présentes modalités.</p>
      <p>
      ...
      <p className="mentionslegales__subtitle">Éditeur du Site</p>
      ...
      <p>Email : contact@meetdev.fr</p>

      <p>Site Web : www.meetdev.fr</p>
      ...
      <p>Nous vous recommandons de recourir à des navigateurs modernes
